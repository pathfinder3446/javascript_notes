//! 1. yöntem (Array literal)-daha çok tercih edilen yöntem
...
const sayilar = new Array(3,2,1);
console.log(sayilar);


const sayi = new Array(10);
console.log(sayi); //! 10 elemanlı boi bir array tanımladı.
